...
Release-like CMake builds enable LTO by default through `FIX8_RELEASE_ENABLE_LTO=ON`; optional host-specific tuning can be enabled with `-DFIX8_RELEASE_MARCH_NATIVE=ON`.
